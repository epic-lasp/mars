...
class Planet:
    ...
    def __init__(self):
        ...
        self.ice_cp0 = None # heat capacity of ice at average surface temp. [J.kg.K-1]
        self.ice_cpCoeff = None# Heat capacity of ice polynomial coefficients
...
#
Mars.Qb = 0.019 #Heat flow [W.m-2] (From Parro et al. 2017)
#
...
Mars.Gamma = 55. #Thermal inertia [J.m-2.K-1.s-1/2]
Mars.ks = 1e-2 # Solid (phonon) conductivity at surface [W.m-1.K-1]
Mars.kd = 3e-2 # Solid (phonon) conductivity at depth z>>H [W.m.K-1]
